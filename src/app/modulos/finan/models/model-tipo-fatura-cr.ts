...
/**
 * Manutenção de Tipos de Faturas do Contas a Receber disponíveis no sistema.
 * Esta API permite a inclusão, alteração, exclusão física e consulta de dados.
 */

export class ModelTipoFaturaCR extends ApiErrorCollection {

    /**
     * Código do Tipo de Fatura do Contas a Receber
     */
     inCodTipoFaturaCR: number;

    /**
     * Descrição do Tipo de Fatura do Contas a Receber
     */
     chDescricao: string;
