...
@Component({
  selector: 'app-crude-logradouro-listagem',
  templateUrl: './crude-logradouro-listagem.component.html',
  styleUrls: ['./crude-logradouro-listagem.component.scss']
})
export class CrudeLogradouroListagemComponent implements OnInit {

  @ViewChild('gridFiltro', { static: true }) gridFiltro: GridPesquisaComponent;
  @ViewChild('breadcrumb_traducao', { static: true }) breadcrumb_traducao: ElementRef;
  public gridRotasCadastro: string = '/modulos/corp/logradouro';
  ...
  public getColunasGridCadastro(): Array<GridPesquisaColumn> {
    return this.apiLogradouroService.getColunasGrid()
  }
}
