...
@Injectable()
export class ApiSeguradoService {  
  private url: string = 'eseg/api/SeguradoEL02';
  ...
  public criar(objeto: ModelSegurado): Promise<ModelSegurado> {
    return new Promise<ModelSegurado>(
      (resolve, reject) => {

        this.apiGatewayService.post<ModelSegurado>(this.url, objeto, true)
          .then(
            objeto_retornado => {
  ...
  public alterar(objeto: ModelSegurado): Promise<ModelSegurado> {
    return new Promise<ModelSegurado>(
      (resolve, reject) => {

        this.apiGatewayService.put<ModelSegurado>(this.url, objeto, true)
          .then(
            objeto_retornado => {
              resolve(objeto_retornado);
            },
  ...
  public obter(id: number): Promise<ModelSegurado> {
    return new Promise<ModelSegurado>(
      (resolve, reject) => {

        let url: string = `${this.url}/${id}`;

        this.apiGatewayService.get<ModelSegurado>(url, true)
          .then(
            objeto_retornado => {
  ...
  public listar(page: number, pageSize: number, filter: string): Promise<Array<ModelSegurado>> {
    ...
    return new Promise<Array<ModelSegurado>>(
      (resolve, reject) => {

        this.apiGatewayService.get<Array<ModelSegurado>>(url, true)
          .then(
            (lista_objetos) => {
  ...
  public listarJuridicas(page: number, pageSize: number, filter: string): Promise<Array<ModelSegurado>> {
  ...
  public getColunasGrid(): Array<GridPesquisaColumn> {
    ...
    localeFile = this.assetsLocaleService.getLocaleFile('modulos.eseg.api.api-segurado.service.ts');
