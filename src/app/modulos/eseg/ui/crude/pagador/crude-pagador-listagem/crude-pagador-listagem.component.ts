...
@Component({
  selector: 'app-crude-pagador-listagem',
  templateUrl: './crude-pagador-listagem.component.html',
  styleUrls: ['./crude-pagador-listagem.component.scss']
})
export class CrudePagadorListagemComponent implements OnInit {

  public gridRotasCadastro: GridRotaCadastro[] = [
    {
      nomeCampo: 'inCodTipoPessoa',
      valorCampo: 1,
      rota: '/modulos/eseg/pagador/fisica',
      textoBotaoCriarNovo: 'Física'
    },
    {
      nomeCampo: 'inCodTipoPessoa',
      valorCampo: 2,
      rota: '/modulos/eseg/pagador/juridica',
  ...
  constructor(
    public apiService: ApiPagadorService,
