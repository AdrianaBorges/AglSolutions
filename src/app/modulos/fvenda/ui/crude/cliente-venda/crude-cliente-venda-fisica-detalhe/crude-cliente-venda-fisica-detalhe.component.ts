...
@Component({
  selector: 'app-crude-cliente-venda-fisica-detalhe',
  templateUrl: './crude-cliente-venda-fisica-detalhe.component.html',
  styleUrls: ['./crude-cliente-venda-fisica-detalhe.component.scss']
})
export class CrudeClienteVendaFisicaDetalheComponent implements OnInit {
  ...
  private criarForm(emEdicao: boolean) {
    ...
    var CPF: string = (this.modelClienteEl02.inNumIdentifCliente > 0 ? (this.modelClienteEl02.inNumIdentifCliente + '').padStart(11, "0") : '');
    this.modelClienteEl02['CPF'] = CPF;

    if (this.modelClienteEl02.daDatNascim) {
      this.modelClienteEl02.daDatNascim = new Date(this.modelClienteEl02.daDatNascim);
    }
    ...
    if (this.meuForm) {
      ...
      this.meuForm = this.formB.group({
        ...
        daDatNascim: [this.modelClienteEl02.daDatNascim, Validators.required],
        CPF: [CPF, Validators.required],

        chNomeMae: [this.modelClienteEl02.chNomeMae],
        chNomePai: [this.modelClienteEl02.chNomePai],
  ...
  private coletarDadosForm() {
    ...
    this.modelClienteEl02.inNumIdentifCliente = this.meuForm.value.CPF;
  ...
  private getPessoa() {
    ...
    if (id == 0) {
      ...
      this.modelClienteEl02 = new ModelClienteEl02();
      this.modelClienteEl02.inCodTipoDocumentoCliente = 1; //Pessoa Física
      this.modelClienteEl02.inCodTipoPessoaCliente = 1; //CPF
      this.modelClienteEl02.IDCliente = 0;
      this.modelClienteEl02.daDatNascim = null;
      ...
      this.modelClienteEl02.IDPapelPessoaPagador = null;
      this.modelClienteEl02.IDClientePai = null;
      this.modelClienteEl02.chNomePai = '';
      this.modelClienteEl02.chNomeMae = '';
