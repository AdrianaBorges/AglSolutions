...
@Component({
  selector: 'app-crude-aprova-credito-aprova-detalhe',
  templateUrl: './crude-aprova-credito-aprova-detalhe.component.html',
  styleUrls: ['./crude-aprova-credito-aprova-detalhe.component.scss']
})
export class CrudeAprovaCreditoAprovaDetalheComponent implements OnInit {
  ...
  private criarForm(emEdicao: boolean) {
    ...
    if (this.meuForm) {
      ...
      this.meuForm.get('deValCredAprov').setValue(Math.ceil(this.modelSolicCredVendaEL01.deValCredSolic));
    } else {
    ...
    //Habilita o comando de confirmar e desfazer sem que o usuário venha a interagir com o formulário
    this.meuForm.markAsTouched()
  }
  ...
  btnConfirmar() {
    this.cadastroBarraAcao.exibirAguarde(()=>{
      ...
      this.modelSolicCredVendaEL01.inCodSituacaoSolicCred = 3;
