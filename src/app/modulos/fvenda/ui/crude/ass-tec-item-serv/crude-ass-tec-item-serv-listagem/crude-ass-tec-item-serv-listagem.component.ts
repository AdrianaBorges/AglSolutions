...
@Component({
  selector: 'app-crude-ass-tec-item-serv-listagem',
  templateUrl: './crude-ass-tec-item-serv-listagem.component.html',
  styleUrls: ['./crude-ass-tec-item-serv-listagem.component.scss']
})
export class CrudeAssTecItemServListagemComponent implements OnInit {
  ...
  public getColunasGridCadastro(): Array<GridPesquisaColumn> {
    return this.apiAssTecItemServService.getColunasGrid();
  }
