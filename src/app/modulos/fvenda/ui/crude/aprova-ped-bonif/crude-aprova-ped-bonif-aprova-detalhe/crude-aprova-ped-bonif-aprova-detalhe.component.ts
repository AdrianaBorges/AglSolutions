...
@Component({
  selector: 'app-crude-aprova-ped-bonif-aprova-detalhe',
  templateUrl: './crude-aprova-ped-bonif-aprova-detalhe.component.html',
  styleUrls: ['./crude-aprova-ped-bonif-aprova-detalhe.component.scss']
})
export class CrudeAprovaPedBonifAprovaDetalheComponent implements OnInit {
  ...
  btnConfirmar() {
    this.cadastroBarraAcao.exibirAguarde(() => {
      ...
      this.modelSolicAprovPVEL01.inCodSituacaoSolAprPV = 3;
      this.alterar();
