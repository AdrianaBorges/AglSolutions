/**
 * Manutenção de Defeitos Constatados do Item da Assistência Técnica disponíveis no sistema.
 * Esta API permite a inclusão, alteração, exclusão física e consulta de dados.
 */
export class ModelAssTecItemDefConst {

    /**
    Identificador Único da Tabela (Gerado Automaticamente)
     */
    IDAssTecItemDefConst: number;
