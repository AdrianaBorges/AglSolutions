...
@Injectable()
export class ApiUsuariosDoGrupoService {
  ...
  private chCodGrupoUsuario: string;
  ...
  public setCodGrupoUsuario(chCodGrupoUsuario: string) {
    this.chCodGrupoUsuario = chCodGrupoUsuario;
  }

  public getCodGrupoUsuario(): string {
    return this.chCodGrupoUsuario;
  }
  ...
  public listar(page: number, pageSize: number, filter: string): Promise<Array<ModelUsuariosGrupo>> {
    ...
    if ((this.chCodGrupoUsuario != "") && (this.chCodGrupoUsuario != undefined)) {
      if (filter != '') {
        filter += `~and~`;
      }
      filter += `UsuariosGrupo.chCodGrupoUsuario~eq~'${this.chCodGrupoUsuario}'`;
  ...
  public getColunasGrid(): Array<GridPesquisaColumn> {
    ...
    colunas.push(new GridPesquisaColumn(localeFile.traducao('chCodGrupoUsuario'), 'UsuariosGrupo.chCodGrupoUsuario', 'chCodGrupoUsuario'  , enum_formatoColuna.texto  , true       , true));
    colunas.push(new GridPesquisaColumn(localeFile.traducao('chDesGrupoUsuario'), 'GrupoUsuario.chDesGrupoUsuario' , 'chDesGrupoUsuario'  , enum_formatoColuna.texto  , true       , true));
    colunas.push(new GridPesquisaColumn(localeFile.traducao('chCodUsuario')     , 'UsuariosGrupo.chCodUsuario'     , 'chCodUsuario'       , enum_formatoColuna.texto  , true       , false , false      , 300));
