...
@Component({
  selector: 'app-usu-alterar-senha',
  templateUrl: './usu-alterar-senha.component.html',
  styleUrls: ['./usu-alterar-senha.component.scss']
})
export class UsuAlterarSenhaComponent implements OnInit {
